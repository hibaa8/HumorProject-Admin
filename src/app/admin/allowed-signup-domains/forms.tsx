...
export function CreateAllowedSignupDomainForm() {
  const [state, formAction] = useActionState(createAllowedSignupDomainAction, idle);
...
export function AllowedSignupDomainRow({ row }: { row: { id: number; apex_domain: string } }) {
  const [updateState, updateAction] = useActionState(updateAllowedSignupDomainAction, idle);
  const [deleteState, deleteAction] = useActionState(deleteAllowedSignupDomainAction, idle);
